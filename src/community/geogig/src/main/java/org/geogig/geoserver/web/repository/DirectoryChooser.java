...
public class DirectoryChooser extends Panel {
    ...
    static abstract class DirectoryDataView extends Panel {
        ...
        private static final ResourceReference folder = new PackageResourceReference(
                GeoServerBasePage.class, "img/icons/silk/folder.png");

        private static final ResourceReference geogigFolder = new PackageResourceReference(
        ...
        private final IConverter<String> FILE_NAME_CONVERTER = new StringConverter() {
        ...
        private static final IConverter<String> FILE_LASTMODIFIED_CONVERTER = new StringConverter() {
        ...
        private static abstract class StringConverter implements IConverter<String> {
