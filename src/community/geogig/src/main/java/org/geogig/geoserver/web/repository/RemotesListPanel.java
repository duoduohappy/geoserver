...
public class RemotesListPanel extends GeoServerTablePanel<RemoteInfo> {
    ...
    private RemotesProvider provider;

    private FeedbackPanel pingFeedbackPanel;
    ...
    private Component nameLink(String id, IModel<RemoteInfo> itemModel) {
        ...
        IModel<String> nameModel = RemotesProvider.NAME.getModel(itemModel);
    ...
    protected Component removeLink(final String id, final IModel<RemoteInfo> itemModel) {
        ...
        return new ImageAjaxLink(id, removeIcon) {
            ...
            private IModel<RemoteInfo> model = itemModel;
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                dialog.showOkCancel(target, new GeoServerDialog.DialogDelegate() {
                    ...
                    protected boolean onSubmit(AjaxRequestTarget target, Component contents) {
                        ...
                        items.remove(remote);
                        target.addComponent(RemotesListPanel.this);
    ...
    static class RemotesProvider extends GeoServerDataProvider<RemoteInfo> {
        ...
        private ArrayList<RemoteInfo> items;

        public RemotesProvider(final List<RemoteInfo> remotes) {
            this.items = new ArrayList<RemoteInfo>(remotes);
        }
        ...
        @Override
        public IModel<RemoteInfo> newModel(Object object) {
            return new Model<RemoteInfo>((RemoteInfo) object);
        }
    }
    ...
    private final class RemotePingLink extends SimpleAjaxLink<RemoteInfo> {
        ...
        private RemotePingLink(String id, IModel<RemoteInfo> model) {
            super(id, model, new Model<String>("ping"));
        }
        ...
        protected void onClick(AjaxRequestTarget target) {
            ...
            target.addComponent(pingFeedbackPanel);
        }
    }
